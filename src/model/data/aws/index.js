...
async function writeFragment(fragment) {
  logger.debug({ fragment }, 'Metadata in writeFragment before sending');
...
async function readFragment(ownerId, id) {
  ...
  try {
    ...
    logger.debug({ data }, 'Metadata in readFragment after GET call');
...
async function deleteFragment(ownerId, id) {
  ...
  // Configure our metadata DELETE params, with the name of the table and key (partition key + sort key)
  ...
  try {
    ...
    logger.error({ err, TableName, Key }, 'Error deleting fragment data from DynamoDB');
    throw new Error('unable to delete fragment data');
  }
}
